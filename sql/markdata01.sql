...
INSERT INTO `news` (`id`, `user_id`, `title`, `content`, `date`, `status`, `picture`, `conclusion`) VALUES
...
INSERT INTO `user` (`id`, `std_id`, `username`, `password`, `firstname`, `lastname`, `email`, `status`, `career`) VALUES
	(1, '6010450586', 'folkdogfk', '$2y$10$J6LzFHw7XAeZvsM0FNuR4O8GTnestQ5uAgs5AWjuuqT5E8VHta.X2', 'Pattarapon', 'poltakhu', 'folk@folk.com', 'admin', 'hihiihihiihii'),
	(10, '6010450497', 'marksos', '$2y$10$UpgNNn9VXGcYiOAr15r53OyNZv4wW2itKhvSgV5fuL5VY5jXxEIOG', 'Pruettipong', 'Oonsud', 'puettipong.o@ku.th', 'alumni', 'teacher'),
	(12, '123456', 'markky2117', '$2y$10$n4Q1Gz/ZQiu14WecpMP/OeRXN8lsTkDQtUKdZT00BDoV3V/1HrViK', 'Puettipong', 'Onsud', 'markkylukfolk@ku.th', 'officer', 'officer');
