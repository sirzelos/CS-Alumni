...
<head>
  ...
  <title>เพิ่มข้อมูลนิสิตเก่า</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="this is content">
      <div class="row">
        <form class="col s12 " action="adddataalumnidb.php" method="post" enctype="multipart/form-data">
          <br><br>
          <div class="row">
            <div class="input-field col s6">
              <div class="teal-text text-lighten-1">First Name</div> <input name="first_name" type="text" class="validate" required>
            </div>
            <div class="input-field col s6">
              <div class="teal-text text-lighten-1">Last Name </div><input name="last_name" type="text" class="validate" required>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <div class="teal-text text-lighten-1">Student ID</div><input name="std_id" type="text" class="validate" required>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <div class="teal-text text-lighten-1">E-mail</div> <input name="email" type="email" class="validate" required>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <div class="teal-text text-lighten-1">Career</div> <input name="career" type="text" class="validate" required>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <div class="teal-text text-lighten-1">Generation </div><input name="gen" type="text" class="validate" required>
            </div>
          </div>
          <div class="row">
            <button class="btn waves-effect waves-light col s2 offset-s5" type="submit" name="action">เพิ่มข้อมูล
