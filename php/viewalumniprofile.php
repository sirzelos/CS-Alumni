  ...
  <?php
        ...
        $run->execute();
         ...
         foreach($run as $b){
            ...
            echo "<table>";
            echo "<tr>";
            echo "<td><font color = blue size=5px><p align=center>Fisrt Name</font></td>";
            echo "<td><font color = black size=5px><p align=center>" .$b['firstname']."</font></td>";
            echo "</tr>";
            echo "<tr>";
            echo "<td><font color = blue size=5px><p align=center>Last Name</font></td>";
            echo "<td><font color = black size=5px><p align=center>".$b['lastname']."</font></td>";
            echo "</tr>";
            echo "<tr>";
            echo "<td><font color = blue size=5px><p align=center>Student ID</font></td>";
            echo "<td><font color = black size=5px><p align=center>".$b['std_id']."</font></td>";
            echo "</tr>";
            echo "<tr>";
            echo "<td><font color = blue size=5px><p align=center>E-mail</font></td>";
            echo "<td><font color = black size=5px><p align=center>".$b['email']."</font></td>";
            echo "</tr>";
            
            echo "<tr>";
            echo "<td><font color = blue size=5px><p align=center>Generation</font></td>";
            echo "<td><font color = black size=5px><p align=center>".$b['gen']."</font></td>";
            echo "</tr>";
            echo "<tr>";
            echo "<td><font color = blue size=5px><p align=center>Career</font></td>";
            echo "<td><font color = black size=5px><p align=center>".$b['career']."</font></td>";
            echo "</tr>";
            echo "</table>";
        }?><br><br>
        <form action = editdatabyalumni.php>
        <div class="row">
