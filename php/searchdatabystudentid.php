...
<body>
  ...
  <div class="container">
    ...
    <div class="content-container">
      <div class="row">
        <form class="col s12 " action="searchstudentidforedit.php" method="post" enctype="multipart/form-data">
          <br><br>
          <div class="row">
          ...
          <div class="row">
            <button class="btn waves-effect waves-light col s2 offset-s5" type="submit" name="action">ค้นหานิสิต
