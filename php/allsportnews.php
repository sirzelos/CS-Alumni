          ...
          <li class = "right my-dropdown"><a class = "no-hover" style="height:64px;" href="#"><i class="right material-icons md-48 icon-position">ballot</i><p class = "left my-dropdown-content text-center">News</p></a>
              <div class="my-dropdown-content color-nav">
                ...
                if ($_SESSION['status'] == 'alumni' or $_SESSION['status'] == 'officer'){
                  echo "<a class = 'hover-bottom-solid' href='addallsportnews.php'><i class='left material-icons md-48 icon-context'>add</i>ประกาศข่าวสาร/ประชาสัมพันธ์</a>
    ...
    <div class="">
      <div class="w3-row">
        <a href="javascript:void(0)" onclick="openCity(event, 'new1');">
          <div class="w3-third tablink w3-bottombar w3-hover-light-grey w3-padding  w3-border-blue"><h3>ข่าวสารกีฬา</h3></div>
        </a>
      </div>
      ...
      <?php
        ...
        if ($page_total != 0){
          if ($page != 1){
            echo "<a class = 'page-button' href='allsportnews.php?page=$prev_page'><<</a>";
          }
          while ($p <= $page_total){
          echo "<a class = 'page-button' href='allsportnews.php?page=$p'>$p</a>";
          $p++;
          }
          if ($page != $page_total){
            echo "<a class = 'page-button' href='allsportnews.php?page=$next_page'>>></a>";
          }
        }
       ?>
     </div>
